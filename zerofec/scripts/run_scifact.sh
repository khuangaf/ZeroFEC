# input_path=$1
output_name=$1
output_dir=output/scifact/$output_name
...
# python candidate_generation/run_candidate_gen.py --input_path ../data/scifact_correct/test.jsonl --output_path $candidate_gen_output_path --use_scispacy
...
# python postprocessing/run_factcc.py --generated_claim_path $claim_output_path --output_path $factcc_output_path

# python evals/run_eval.py --generated_final_path ../generated_claims_with_scores/all_test_np_ner_gold_evidence_fcpre_mixqg_qa_dec_gec_factcc.json
